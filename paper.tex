...
\section{Numerical Techniques \label{sec:technical}}
	...
	For $q$ below some cutoff $q_{uc}$ on the order of $q_{\mathrm{F}}$, this picks the Nam reflection coefficient and reflects the diminished noise in the superconducting state.\todo{Does this need to be justified with a graph of the results?}
